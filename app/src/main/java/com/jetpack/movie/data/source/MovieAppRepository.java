...
public class MovieAppRepository implements MovieAppDataSource {
    ...
    MovieAppRepository(@NonNull RemoteRepository remoteRepository) {
        this.remoteRepository = remoteRepository;
    }

    public static MovieAppRepository getInstance(RemoteRepository remoteData) {
        if (INSTANCE == null) {
            synchronized (MovieAppRepository.class) {
                if (INSTANCE == null) {
                    INSTANCE = new MovieAppRepository(remoteData);
                }
            }
        }
        return INSTANCE;
